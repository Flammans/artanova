...
import {Eye, EyeSlash, EnvelopeSimple, Lock, UserCircle, ArrowRight, WarningCircle} from 'phosphor-react'
...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (emailIsValid && usernameIsValid && passwordsMatch && passwordIsValid) {
